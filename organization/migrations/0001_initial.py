...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='listing_skills',
            fields=[
                ('listing_id', models.IntegerField(default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='organization',
            fields=[
                ('organization_id', models.IntegerField(default=0, primary_key=True, serialize=False)),
                ('company_name', models.CharField(blank=True, max_length=30)),
                ('company_email', models.CharField(blank=True, max_length=70)),
                ('company_address', models.CharField(blank=True, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='person.applicant')),
                ('organization_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='organization.organization')),
            ],
        ),
        migrations.CreateModel(
            name='mentor',
