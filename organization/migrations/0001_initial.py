    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compensation', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=7, null=True)),
        ...
        migrations.CreateModel(
            name='listing_skills',
            fields=[
                ('skill_listing_id', models.AutoField(primary_key=True, serialize=False)),
